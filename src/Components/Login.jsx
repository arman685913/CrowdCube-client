    ...
    return (
        <div className='lg:my-28 my-20 p-6 md:p-10'>
            <div className="flex justify-center items-center  ">
                ...
                <form onSubmit={handleLogin} className="relative bg-gray-100 border border-green-300 rounded-lg  p-4 shadow-md max-w-6xl w-full  ">
            ...
            <div className='flex px-2 max-w-6xl mx-auto justify-center  mt-4 gap-4'>
                ...
                {/* Google */}
                <button onClick={handleGoogle} className="btn w-1/2 border-2 bg-white text-black border-[#e5e5e5]">
